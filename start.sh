...
export LOCAL_VERSION_BOOTSTRAP=1.70.3-master #module @nebulario/linker-local-bootstrap-graph
export LOCAL_VERSION_GRAPH=1.70.0-http-linker-prod #module repoflow/linker-local-handler-graph-container
